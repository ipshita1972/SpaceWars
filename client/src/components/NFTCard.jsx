...
const NFTCard = ({ nft, setOwnedNFTs }) => {
    ...
    <div className="w-64 p-4 rounded-lg bg-gradient-to-b from-gray-700 via-gray-800 to-gray-900 shadow-lg mt-5">
        ...
        <button className="px-4 py-2 rounded-lg bg-blue-500 hover:bg-blue-600 text-white font-bold"
            onClick={() => setIsListModalOpen(!isListModalOpen)}
        >List
        </button>
        <button className="px-4 py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white font-bold"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
            ...
            <input className="p-3 w-full rounded-md bg-gray-700 text-white text-lg mb-6"
                type="number"
                value={price}
